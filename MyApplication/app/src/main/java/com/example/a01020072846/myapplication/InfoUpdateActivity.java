...
public class InfoUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new UserInfoAsyncTask().execute("http://192.168.33.136:8080/TodayMyStore/AndroidController?command=android_user_info", intent.getStringExtra("id"));
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new UpdateAsyncTask().execute("http://192.168.33.136:8080/TodayMyStore/AndroidController?command=android_info_update", id, pw, name, email, phone);
            }
        });
