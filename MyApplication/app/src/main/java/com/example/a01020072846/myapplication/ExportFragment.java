...
public class ExportFragment extends Fragment {
    ...
    @SuppressLint("ValidFragment")
    public ExportFragment(Context mContext, String userId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        minusBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new ItemRemoveAsyncTask().execute("http://"+ getString(R.string.server_ip) +":8080/TodayMyStore/AndroidController?command=android_remove_item", "export", userId);
            ...
            addOkBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(name.length() == 0 || price.length() == 0) {
                        ...
                        new ItemAddAsyncTask().execute("http://"+ getString(R.string.server_ip) +":8080/TodayMyStore/AndroidController?command=android_add_item", "export", name, price ,userId);
                        nameEt.setText("");
                        priceEt.setText("");
                        dismiss();
                    }
